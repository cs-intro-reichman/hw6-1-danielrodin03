...
public class Runigram {
	...
	private static void print(Color c) {
	    System.out.print("(");
		System.out.printf("%3d,", c.getRed());   // Prints the red component
		System.out.printf("%3d,", c.getGreen()); // Prints the green component
        System.out.printf("%3d",  c.getBlue());  // Prints the blue component
        System.out.print(")  ");
	}
